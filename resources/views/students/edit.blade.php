...
@section('title', isset($student) ? 'Editar Estudante' : 'Criar Estudante')

@section('content')
<div class="container mx-auto px-4">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">{{ isset($student) ? 'Editar Estudante' : 'Adicionar Novo Estudante' }}</h1>
            ...
            <div class="p-6 space-y-6">
                <div class="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="cpf" id="cpf" value="{{ old('cpf', $student->cpf ?? '') }}" 
